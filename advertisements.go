...
func newAdvertisements(sdkConfig sdkConfiguration) *Advertisements {
...
func (s *Advertisements) List(ctx context.Context, benefitID string, page *int64, limit *int64, sorting []components.AdvertisementSortProperty, opts ...operations.Option) (*operations.AdvertisementsListResponse, error) {
	...
	res := &operations.AdvertisementsListResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.AdvertisementsListResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AdvertisementCampaignListResource
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AdvertisementCampaignListResource = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Advertisements) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.AdvertisementsGetResponse, error) {
	...
	res := &operations.AdvertisementsGetResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AdvertisementCampaign
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AdvertisementCampaign = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
